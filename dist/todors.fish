...
complete -c todors -n "__fish_todors_needs_command" -f -a "e" -d 'Edit the todo file with a text editor'
...
complete -c todors -n "__fish_todors_using_subcommand e" -s h -l help -d 'Print help'
